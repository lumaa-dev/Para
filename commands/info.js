...
module.exports = {
    ...
    execute(interaction) {
        const pages = [
            new EmbedBuilder()
            .setTitle("Général")
            .setDescription("Ce bot de protection à été fait à la base pour être un simple de bot de modération, par la suite, il deviendra ce qu'il est aujourd'hui : Un bot qui protège ses utilisateurs contre les raids et grief.\nD'autres commandes diverses fut créées pendant le processus.\n\nPar [Lumaa](https://lumination.brebond.com)"),
            new EmbedBuilder()
